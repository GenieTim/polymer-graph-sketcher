...
export class Colour {
  ...
  public static rgb2xyz(
    ...
    const [lr, lg, lb] = [r / 255, g / 255, b / 255].map(
      (c) => linearize(c) * 100
    );
  ...
  public static xyz2rgba(
    ...
    const g = xyz[0] * -0.969266 + xyz[1] * 1.8760108 + xyz[2] * 0.041556;
